...
import CardsInfReports from '@/components/cards/influencers/CardsInfReports'
    ...
    <div className="flex w-[98%] py-4">
      <div className="flex flex-col justify-center items-center gap-8 w-full">
        ...
        <div className="bg-[#111111] py-4 w-full rounded-xl flex flex-col gap-4">
          ...
          <CardsInfReports image={"/icons/ProfileIcon.svg"} name='Jane Cooper' mail='jane.cooper@example.com' amount={"30"} /> 
          <CardsInfReports image={"/icons/ProfileIcon.svg"} name='Jane Cooper' mail='jane.cooper@example.com' amount={"30"} /> 
        </div>
      </div>
    </div>
