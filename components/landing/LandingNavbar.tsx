      ...
      <nav className="z-10 md:bg-[#4A4A4A] mt-2 md:mt-10 w-[90%] rounded-md items-center justify-between text-[0.75rem] lg:text-sm font-semibold text-white flex">
        ...
        <div className="md:flex w-[90%] justify-evenly items-center hidden">
          ...
          <div className="mr-4">
            ...
            {
              isAuthenticated ?
                <div onMouseEnter={() => setIsOpen(true)} onMouseLeave={() => setIsOpen(false)} className="relative cursor-pointer">
                  ...
                  <div className={isOpen ? 'd-block absolute z-40 flex flex-col h-auto text-sm text-black bg-[#545454] rounded-md right-3 top-7 drop-shadow-md w-52 bg-dblu11 text-white ' : 'hidden'}
                  >
                    ...
                    <hr />
                    <button className="w-full hover:bg-[#6E6E6E]" onClick={() => handleLogOut()}>
                ...
                :
                <button className="border px-6 py-2 rounded hover:bg-white hover:text-black" onClick={() => setShowAuthFlow(true)}>Login</button>
            }
